...
output "generated_cluster_private_ssh_key" {
  ...
  sensitive   = true
  value       = try(azurerm_kubernetes_cluster.aks.linux_profile[0], null) != null ? (var.configuration.public_ssh_key == "" || var.configuration.public_ssh_key == null ? tls_private_key.ssh[0].private_key_pem : null) : null
}
...
output "generated_cluster_public_ssh_key" {
  ...
  value       = try(azurerm_kubernetes_cluster.aks.linux_profile[0], null) != null ? (var.configuration.public_ssh_key == "" || var.configuration.public_ssh_key == null ? tls_private_key.ssh[0].public_key_openssh : null) : null
}
